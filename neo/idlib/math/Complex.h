...
ID_INLINE void idComplex::Zero(void) { r = i = 0.0f; }
...
ID_INLINE idComplex idComplex::operator-() const { return idComplex(-r, -i); }
...
ID_INLINE idComplex idComplex::operator*(const idComplex& a) const { return idComplex(r * a.r - i * a.i, i * a.r + r * a.i); }
...
ID_INLINE idComplex idComplex::operator+(const idComplex& a) const { return idComplex(r + a.r, i + a.i); }
...
ID_INLINE idComplex idComplex::operator*(const float a) const { return idComplex(r * a, i * a); }
...
ID_INLINE idComplex idComplex::operator+(const float a) const { return idComplex(r + a, i); }
...
ID_INLINE idComplex operator*(const float a, const idComplex& b) { return idComplex(a * b.r, a * b.i); }
...
ID_INLINE idComplex operator+(const float a, const idComplex& b) { return idComplex(a + b.r, b.i); }
...
ID_INLINE bool idComplex::Compare(const idComplex& a) const { return ((r == a.r) && (i == a.i)); }
...
ID_INLINE bool idComplex::operator==(const idComplex& a) const { return Compare(a); }

ID_INLINE bool idComplex::operator!=(const idComplex& a) const { return !Compare(a); }

ID_INLINE int idComplex::GetDimension(void) const { return 2; }

ID_INLINE const float* idComplex::ToFloatPtr(void) const { return &r; }

ID_INLINE float* idComplex::ToFloatPtr(void) { return &r; }

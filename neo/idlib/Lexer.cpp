...
static const punctuation_t default_punctuations[] = {
  // binary operators
  {">>=", P_RSHIFT_ASSIGN}, {"<<=", P_LSHIFT_ASSIGN},
  //
  {"...", P_PARMS},
  ...
  {"*=", P_MUL_ASSIGN}, {"/=", P_DIV_ASSIGN}, {"%=", P_MOD_ASSIGN}, {"+=", P_ADD_ASSIGN}, {"-=", P_SUB_ASSIGN}, {"++", P_INC}, {"--", P_DEC},
  // binary operators
  {"&=", P_BIN_AND_ASSIGN}, {"|=", P_BIN_OR_ASSIGN}, {"^=", P_BIN_XOR_ASSIGN}, {">>", P_RSHIFT}, // pre-compiler
...
================
*/
int idLexer::GetLastWhiteSpaceStart(void) const { return whiteSpaceStart_p - buffer; }
...
================
*/
int idLexer::GetLastWhiteSpaceEnd(void) const { return whiteSpaceEnd_p - buffer; }
...
================
*/
int idLexer::EndOfFile(void) { return idLexer::script_p >= idLexer::end_p; }
...
================
*/
int idLexer::NumLinesCrossed(void) { return idLexer::line - idLexer::lastline; }
...
idLexer::~idLexer(void) { idLexer::FreeSource(); }

void idLexer::SetBaseFolder(const char* path) { idStr::Copynz(baseFolder, path, sizeof(baseFolder)); }

bool idLexer::HadError(void) const { return hadError; }

...
============
*/
void idInternalCVar::InternalSetString(const char* newValue) { Set(newValue, true, false); }
...
===============
*/
void idInternalCVar::InternalServerSetString(const char* newValue) { Set(newValue, true, true); }
...
============
*/
void idInternalCVar::InternalSetBool(const bool newValue) { Set(idStr(newValue), true, false); }
...
============
*/
void idInternalCVar::InternalSetInteger(const int newValue) { Set(idStr(newValue), true, false); }
...
============
*/
void idInternalCVar::InternalSetFloat(const float newValue) { Set(idStr(newValue), true, false); }
...
============
*/
bool idCVarSystemLocal::IsInitialized(void) const { return initialized; }
...
============
*/
idCVar* idCVarSystemLocal::Find(const char* name) { return FindInternal(name); }
...
============
*/
void idCVarSystemLocal::SetCVarString(const char* name, const char* value, int flags) { SetInternal(name, value, flags); }
...
============
*/
void idCVarSystemLocal::SetCVarBool(const char* name, const bool value, int flags) { SetInternal(name, idStr(value), flags); }
...
============
*/
void idCVarSystemLocal::SetCVarInteger(const char* name, const int value, int flags) { SetInternal(name, idStr(value), flags); }
...
============
*/
void idCVarSystemLocal::SetCVarFloat(const char* name, const float value, int flags) { SetInternal(name, idStr(value), flags); }
...
============
*/
void idCVarSystemLocal::SetModifiedFlags(int flags) { modifiedFlags |= flags; }
...
============
*/
int idCVarSystemLocal::GetModifiedFlags(void) const { return modifiedFlags; }
...
============
*/
void idCVarSystemLocal::ClearModifiedFlags(int flags) { modifiedFlags &= ~flags; }
...
============
*/
void idCVarSystemLocal::List_f(const idCmdArgs& args) { ListByFlags(args, CVAR_ALL); }

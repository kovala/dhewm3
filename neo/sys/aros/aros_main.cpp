...
================
*/
void Sys_ShowConsole(int visLevel, bool quitOnClose) { bug("[ADoom3] %s()\n", __PRETTY_FUNCTION__); }
...
void Sys_FPU_SetPrecision(int precision) { bug("[ADoom3] %s()\n", __PRETTY_FUNCTION__); }
...
===============
*/
void Sys_FPU_EnableExceptions(int exceptions) { bug("[ADoom3] %s()\n", __PRETTY_FUNCTION__); }
